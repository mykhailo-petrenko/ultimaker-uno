...
#define STRING_CONFIG_H_AUTHOR "MAPetrenko" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "7b Prusa Mendel"

// Define this to set a unique identifier for this printer, (Used by some programs to differentiate between machines)
// You can use an online service to generate a random UUID. (eg http://www.uuidgenerator.net/version4)
#define MACHINE_UUID "dc9e3057-d84e-42b9-ad8a-e5569c01ba36"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define  DEFAULT_bedKp 516.83
  #define  DEFAULT_bedKi 35.64
  #define  DEFAULT_bedKd 1873.51
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { (200*16)/(2.0*16), (200*16)/(2.0*16), (96*16)/1.00, 306 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1800, 1800, 90, 10000 }
