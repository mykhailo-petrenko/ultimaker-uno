...
#define CUSTOM_MACHINE_NAME "Ultimaker Uno"

// Define this to set a unique identifier for this printer, (Used by some programs to differentiate between machines)
// You can use an online service to generate a random UUID. (eg http://www.uuidgenerator.net/version4)
#define MACHINE_UUID "ffffffff-cccc-dddd-eeee-123345456789"
...
#define  DEFAULT_Kd 49.46

// Ultimaker
//#define  DEFAULT_Kp 26.9
...
// @section homing
#define MIN_Z_HEIGHT_FOR_HOMING 2 // (in mm) Minimal z height before homing (G28) for Z clearance above the bed, clamps, ...
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {200, 200, 800, 187}  // default steps per unit for Ultimaker
#define DEFAULT_MAX_FEEDRATE          {200, 200, 5, 25}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot.
